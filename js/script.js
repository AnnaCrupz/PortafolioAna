...
const b_portafolio=d.getElementById('portafolio_boton');

  b_portafolio.addEventListener("click", 
    console.log("portafolio seleccionado"));

  function llamadaPortafolio() {
...
var TxtRotate = function(el, toRotate, period) {
  ...
  window.onload = function() {
    var elements = d.getElementsByClassName('txt-rotate');
